...
CREATE TABLE IF NOT EXISTS PUBLIC."reviews" (
    ...
    CONSTRAINT REVIEWS_USER_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC."user"(ID),
    CONSTRAINT REVIEWS_FILM_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC."film"(ID)
);
...
CREATE TABLE IF NOT EXISTS PUBLIC."useful" (
    ...
    IS_LIKE BOOLEAN,
    USER_ID INT NOT NULL,
    CONSTRAINT USEFUL_REVIEW_FK FOREIGN KEY (REVIEW_ID) REFERENCES PUBLIC."reviews"(ID),
    CONSTRAINT USEFUL_USER_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC."user"(ID)
);
